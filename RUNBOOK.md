...
## 1. Backend
```bash
cd /home/anurag-basistha/Projects/Done/Verified/Gram-Connect/backend
python3 -m venv .venv
...
```bash
cd /home/anurag-basistha/Projects/Done/Verified/Gram-Connect/frontend
npm install
...
- `backend/run_full_verification.py` trains `backend/runtime_data/canonical_model.pkl` and verifies:
  - dataset integrity
...
```bash
cd /home/anurag-basistha/Projects/Done/Verified/Gram-Connect
