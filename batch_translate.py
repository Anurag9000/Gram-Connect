...
# Prioritize Bengali and Kannada, then the rest
langs = ['bn', 'kn', 'hi', 'te', 'mr', 'ta', 'ur', 'gu', 'ml', 'or', 'pa', 'as']
...
for lang in langs:
    ...
    chunks = list(chunk_list(values, 50))
    for i, batch in enumerate(chunks):
        try:
            ...
            print(f"[{lang}] Batch {i+1} failed: {e}. Falling back to English.")
