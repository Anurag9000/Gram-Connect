...
DATASET_ROOT = r"D:\SocialCode\gram_sahayta_dataset_with_locations_and_availability"
DEFAULT_MODEL_PATH = os.path.join("model.pkl")
...
class RecommendRequest(BaseModel):
    ...
    severity: Optional[str] = Field(None, regex="^(LOW|NORMAL|HIGH)$")
